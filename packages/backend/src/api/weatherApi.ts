...
const authenticateToken = (
  ...
  if (token === '11ATZZ42I0C84IeKITk872_VtXFwI63E3pvF13JMqCCW5XhRdkCTDkisG8p31xwMkLDDRUF22OLU3C3lAf') {
...
// Public route for non-authenticated access
router.get('/PublicWeatherForecast', (_req: Request, res: Response) => {
  res.status(200).json(weatherForecasts);
});
